...
public class CalculateService {
    ...
    public void execute() {
        ...
        DateTimeFormatter simpleDateFormat = DateTimeFormatter.ofPattern("d.M.y;H:m");
        try {
            ...
            for (int i = 0; i < array.size(); i++) {
                ...
                Duration duration = Duration.between(departureDateTime, arrivalDateTime.plusHours(OFFSET));
